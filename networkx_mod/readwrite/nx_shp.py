...
Generates a networkx_mod.DiGraph from point and line shapefiles.
...
def read_shp(path):
    """Generates a networkx_mod.DiGraph from shapefiles. Point geometries are
...
def write_shp(G, outdir):
    """Writes a networkx_mod.DiGraph to two shapefiles, edges and nodes.
