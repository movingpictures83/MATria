...
#    BSD license.
import networkx_mod
from networkx_mod.utils import is_string_like,open_file
...
def read_p2g(path, encoding='utf-8'):
    ...
    use D=networkx_mod.DiGraph(read_p2g(path))
    """
...
def parse_p2g(lines):
    ...
    G=networkx_mod.MultiDiGraph(name=description,selfloops=True)
