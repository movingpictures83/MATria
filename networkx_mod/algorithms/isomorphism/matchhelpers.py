...
Examples
--------
>>> import networkx_mod.algorithms.isomorphism as iso
...
try:
    ...
    # https://github.com/networkx_mod/networkx_mod/issues/949
    # https://github.com/networkx_mod/networkx_mod/issues/1127
...
>>> from networkx_mod.algorithms.isomorphism.matchhelpers import close
>>> from networkx_mod.algorithms.isomorphism import generic_node_match
