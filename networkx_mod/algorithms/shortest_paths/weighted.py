...
__all__ = ['dijkstra_path',
           ...
           'single_source_dijkstra_path_length_product',
...
from networkx_mod.utils import generate_unique_node
...
def single_source_dijkstra_path_length_product(G, source, cutoff=None,
                                       weight='weight'):
