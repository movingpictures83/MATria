...
from networkx_mod.utils import open_file, make_str, not_implemented_for
...
def read_edgelist(path, comments="#",
    ...
    create_using : Graph container, optional,
       Use specified container to build graph.  The default is networkx_mod.Graph,
       an undirected graph.
    ...
    -------
    G : graph
       A networkx_mod Graph or other type specified with create_using
