...
The bipartite algorithms are not imported into the networkx_mod namespace
at the top level so the easiest way to use them is with:

>>> import networkx_mod as nx
>>> from networkx_mod.algorithms import bipartite
...
from networkx_mod.algorithms.bipartite.basic import *
from networkx_mod.algorithms.bipartite.centrality import *
from networkx_mod.algorithms.bipartite.cluster import *
from networkx_mod.algorithms.bipartite.edgelist import *
from networkx_mod.algorithms.bipartite.matching import *
from networkx_mod.algorithms.bipartite.matrix import *
from networkx_mod.algorithms.bipartite.projection import *
from networkx_mod.algorithms.bipartite.redundancy import *
from networkx_mod.algorithms.bipartite.spectral import *
from networkx_mod.algorithms.bipartite.generators import *
