...
class TestKatzCentrality(object):
    ...
    def test_K5(self):
        """Katz centrality: K5"""
        G = networkx_mod.complete_graph(5)
        alpha = 0.1
        b = networkx_mod.katz_centrality(G, alpha)
        v = math.sqrt(1 / 5.0)
        b_answer = dict.fromkeys(G, v)
        for n in sorted(G):
            assert_almost_equal(b[n], b_answer[n])
        nstart = dict([(n, 1) for n in G])
        b = networkx_mod.katz_centrality(G, alpha, nstart=nstart)
        for n in sorted(G):
            assert_almost_equal(b[n], b_answer[n])
    ...
    def test_maxiter(self):
        ...
        max_iter = 0
        try:
            b = networkx_mod.katz_centrality(G, alpha, max_iter=max_iter)
        except networkx_mod.NetworkXError as e:
    ...
    def test_beta_as_scalar(self):
        ...
        b_answer = {0: 0.5598852584152165, 1: 0.6107839182711449,
                    2: 0.5598852584152162}
        G = networkx_mod.path_graph(3)
        b = networkx_mod.katz_centrality(G, alpha, beta)
        for n in sorted(G):
            assert_almost_equal(b[n], b_answer[n], places=4)
    ...
    def test_multigraph(self):
        e = networkx_mod.katz_centrality(networkx_mod.MultiGraph(), 0.1)

    def test_empty(self):
        e = networkx_mod.katz_centrality(networkx_mod.Graph(), 0.1)
        assert_equal(e, {})

    @raises(networkx_mod.NetworkXException)
    def test_bad_beta(self):
        G = networkx_mod.Graph([(0,1)])
        beta = {0:77}
        e = networkx_mod.katz_centrality(G, 0.1,beta=beta)

    @raises(networkx_mod.NetworkXException)
    def test_bad_beta_numbe(self):
        G = networkx_mod.Graph([(0,1)])
        e = networkx_mod.katz_centrality(G, 0.1,beta='foo')
...
class TestKatzCentralityNumpy(object):
    ...
    def test_K5(self):
        ...
        for n in sorted(G):
            assert_almost_equal(b[n], b_answer[n])
        nstart = dict([(n, 1) for n in G])
        b = networkx_mod.eigenvector_centrality_numpy(G)
        for n in sorted(G):
    ...
    def test_P3(self):
        ...
        b_answer = {0: 0.5598852584152165, 1: 0.6107839182711449,
                    2: 0.5598852584152162}
        b = networkx_mod.katz_centrality_numpy(G, alpha)
        for n in sorted(G):
            assert_almost_equal(b[n], b_answer[n], places=4)
    ...
    def test_beta_as_scalar(self):
        ...
        b_answer = {0: 0.5598852584152165, 1: 0.6107839182711449,
                    2: 0.5598852584152162}
        G = networkx_mod.path_graph(3)
        b = networkx_mod.katz_centrality_numpy(G, alpha, beta)
        for n in sorted(G):
            assert_almost_equal(b[n], b_answer[n], places=4)
    ...
    def test_bad_beta(self):
        G = networkx_mod.Graph([(0,1)])
        beta = {0:77}
        e = networkx_mod.katz_centrality_numpy(G, 0.1,beta=beta)

    @raises(networkx_mod.NetworkXException)
    def test_bad_beta_numbe(self):
        G = networkx_mod.Graph([(0,1)])
        e = networkx_mod.katz_centrality_numpy(G, 0.1,beta='foo')
    ...
    def test_K5_unweighted(self):
        ...
        G = networkx_mod.complete_graph(5)
        alpha = 0.1
        b = networkx_mod.katz_centrality(G, alpha, weight=None)
        v = math.sqrt(1 / 5.0)
        b_answer = dict.fromkeys(G, v)
        for n in sorted(G):
            assert_almost_equal(b[n], b_answer[n])
    ...
    def test_P3_unweighted(self):
        ...
        b_answer = {0: 0.5598852584152165, 1: 0.6107839182711449,
                    2: 0.5598852584152162}
        b = networkx_mod.katz_centrality_numpy(G, alpha, weight=None)
        for n in sorted(G):
            assert_almost_equal(b[n], b_answer[n], places=4)
...
class TestKatzCentralityDirected(object):
    ...
    def test_katz_centrality_weighted(self):
        G = self.G
        alpha = self.G.alpha
        p = networkx_mod.katz_centrality(G, alpha)
...
class TestKatzCentralityDirectedNumpy(TestKatzCentralityDirected):
    ...
    def test_katz_centrality_weighted(self):
        G = self.G
        alpha = self.G.alpha
        p = networkx_mod.katz_centrality_numpy(G, alpha)
        for (a, b) in zip(list(p.values()), self.G.evc):
            assert_almost_equal(a, b)
...
class TestKatzEigenvectorVKatz(object):
    ...
    def test_eigenvector_v_katz_random(self):
        np.random.seed(1234)
        G = networkx_mod.gnp_random_graph(10,0.5)
        l = float(max(eigvals(networkx_mod.adjacency_matrix(G).todense())))
        e = networkx_mod.eigenvector_centrality_numpy(G)
        k = networkx_mod.katz_centrality_numpy(G, 1.0/l)
        for n in G:
