...
from networkx_mod.classes.graph import Graph  # for doctests
from networkx_mod.classes.digraph import DiGraph
from networkx_mod.classes.multigraph import MultiGraph
