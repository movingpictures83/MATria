...
from networkx_mod.generators.degree_seq import *
from networkx_mod.utils import uniform_sequence,powerlaw_sequence
...
def test_havel_hakimi_construction():
    ...
    assert_raises(networkx_mod.exception.NetworkXError,
...
def test_random_degree_sequence_graph_raise():
    z=[1, 1, 1, 1, 1, 1, 2, 2, 2, 3, 4]
    assert_raises(networkx_mod.exception.NetworkXUnfeasible,
