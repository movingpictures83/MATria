...
"""Unit tests for the :mod:`networkx_mod.generators.expanders` module.
...
from networkx_mod import adjacency_matrix
from networkx_mod import number_of_nodes
from networkx_mod.generators.expanders import chordal_cycle_graph
from networkx_mod.generators.expanders import margulis_gabber_galil_graph
...
def test_chordal_cycle_graph():
    """Test for the :func:`networkx_mod.chordal_cycle_graph` function."""
