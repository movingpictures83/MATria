...
#    BSD license.
import itertools
from networkx_mod.algorithms.bipartite.generators import complete_bipartite_graph
...
from networkx_mod.utils import is_list_of_ints, flatten
...
def full_rary_tree(r, n, create_using=None):
    ...
    create_using : NetworkX graph type, optional
        Use specified type to construct graph (default = networkx_mod.Graph)
