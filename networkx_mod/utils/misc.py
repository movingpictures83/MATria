...
These are not imported into the base networkx_mod namespace but
can be accessed, for example, as

>>> import networkx_mod
>>> networkx_mod.utils.is_string_like('spam')
True
"""
...
# see G.add_nodes and others in Graph Class in networkx_mod/base.py
...
def cumulative_sum(numbers):
    ...
    >>> import networkx_mod.utils as utils
