...
from networkx_mod.testing import assert_graphs_equal
from networkx_mod.generators.classic import barbell_graph,cycle_graph,path_graph
from networkx_mod.testing.utils import assert_graphs_equal
...
class TestConvertNumpy(object):
    ...
    def identity_conversion(self, G, A, create_using):
        ...
        GW = nx.to_networkx_mod_graph(A, create_using=create_using)
    ...
    def test_from_scipy_sparse_matrix_parallel_edges(self):
        """Tests that the :func:`networkx_mod.from_scipy_sparse_matrix` function
    ...
    def test_symmetric(self):
        ...
        :func:`networkx_mod.from_scipy_sparse_matrix`.
